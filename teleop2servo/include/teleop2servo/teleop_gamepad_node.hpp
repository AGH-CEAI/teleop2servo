...
class TeleopGamepadNode : public rclcpp::Node {
 ...
 private:
  ...
  double button_pair_direction(const sensor_msgs::msg::Joy::SharedPtr& msg,
                               Button positive,
                               Button negative,
                               SpeedMode speed_mode) const;

  std::pair<double, double> axis_direction(const sensor_msgs::msg::Joy::SharedPtr& msg,
                                           Axis x_axis,
                                           Axis y_axis,
                                           Button step_button,
                                           SpeedMode speed_mode) const;
  ...
  void create_cmd_joint(const sensor_msgs::msg::Joy::SharedPtr& msg, const SpeedMode speed_mode, ActiveCmd& cmd);

  void create_cmd_twist(const sensor_msgs::msg::Joy::SharedPtr& msg,
