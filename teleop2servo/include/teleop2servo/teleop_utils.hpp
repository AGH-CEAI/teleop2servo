...
constexpr double get_speed_val(SpeedMode m) {
  switch (m) {
    case SpeedMode::CONT_P5:
      return 0.05;
    case SpeedMode::CONT_P10:
      return 0.10;
    case SpeedMode::CONT_P25:
      return 0.25;
    case SpeedMode::CONT_P50:
      return 0.50;
    case SpeedMode::CONT_P75:
      return 0.75;
...
constexpr ControlMode next(ControlMode mode) {
  switch (mode) {
    ...
    case ControlMode::BASE:
      return ControlMode::TOOL;
    case ControlMode::TOOL:
...
constexpr SpeedMode next(SpeedMode mode) {
  switch (mode) {
    case SpeedMode::STEP:
      return SpeedMode::CONT_P5;
    case SpeedMode::CONT_P5:
      return SpeedMode::CONT_P10;
    case SpeedMode::CONT_P10:
      return SpeedMode::CONT_P25;
    case SpeedMode::CONT_P25:
      return SpeedMode::CONT_P50;
    case SpeedMode::CONT_P50:
      return SpeedMode::CONT_P75;
    case SpeedMode::CONT_P75:
      return SpeedMode::CONT_P100;
    case SpeedMode::CONT_P100:
      return SpeedMode::STEP;
    default:
      return SpeedMode::STEP;
  }
}
